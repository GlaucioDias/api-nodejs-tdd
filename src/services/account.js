...
module.exports = (app) => {
  ...
  // async transforma qualquer retorno desse método em algo tratado como promise
  ...
  const remove = async (id) => {
    ...
    if (transaction) throw new ValidationError('Essa conta possue transações associadas');
