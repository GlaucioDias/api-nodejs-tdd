...
const TOKEN =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTAwMDAsIm5hbWUiOiJVc2VyICMxIiwibWFpbCI6InVzZXJAdGVzdC5jb20ifQ.PITvH2PqEaVD8DqJ_T70-1_X-UCJGuPMLbm_pvUnCfc";
...
test("Deve listar as transferências do usuário", () => {
  return request(app)
    .get(MAIN_ROUTE)
...
describe("Ao salvar uma tranferência válida...", () => {
  let transferId, income, outcome;
...
describe("Ao tentar salvar uma transferência inválida...", () => {
  ...
  test("Não deve inserir sem valor", () =>
    template({ amount: null }, "Valor é um atributo obrigatório"));
...
describe("Ao alterar uma tranferência válida...", () => {
  let transferId;
  let income;
  let outcome;
